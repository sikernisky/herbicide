...
/// 
/// (1) Setting up the skill menu and singletons<br></br>
...
{
    /// <summary>
    /// Reference to the SkillMenuController singleton.
    /// </summary>
    private SkillMenuController instance;
    ...
    {
        SkillMenuController[] skillMenuControllers = FindObjectsOfType<SkillMenuController>();
        Assert.IsNotNull(skillMenuControllers, "Array of found main menu controllers " +
            "is null.");
        Assert.IsTrue(skillMenuControllers.Length == 1, "not enough / too many " +
            "levelcontrollers in the scene (" + skillMenuControllers.Length + ").");
        instance = skillMenuControllers[0];
    }
